...
namespace Balatro
{
    ...
    public class TableCardHolder : HorizontalCardHolder
    {
        ...
        private List<Card> _cardsOnPokerHands;
        ...
        public void SetCardsOnPokerHands(List<Card> cards)
        {
            if (cards == null || cards.Count == 0)
            {
                _cardsOnPokerHands = new List<Card>();
                return;
            }

            _cardsOnPokerHands = new List<Card>(cards);
        }
